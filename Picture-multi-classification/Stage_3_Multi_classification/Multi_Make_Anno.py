...
# # print message
    print('Annotation file Multi_%s_annotation.csv is saved.' % p)
...
NORM_PARAMS.to_csv('Multi_Norm_Params.csv')
print('Normalization parameters file Multi_Norm_Params.csv is saved.')